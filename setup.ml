...
(* OASIS_START *)
(* DO NOT EDIT (digest: ddc1264bba217d14982f6899fd6ac5aa) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "My website using Cowabloga";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "serve.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "·V\141-<\017\005D\130bı≈˘√H\b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
