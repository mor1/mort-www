...
(function() {
  ...
  entry = function(as, e) {
    var address, authors, date, issn, linkbar, links, note, publisher, tags, ttag, venue, _ref;
    ...
    tags = [span('tag', ttag)].concat((_ref = e.tags) != null ? _ref.map(function(t) {
      return span('tag', t);
    }) : void 0).join('; ');
  ...
  $(document).ready(function() {
    ...
    records = {};
    yms = [];
    return $.when(authors, papers).done(function(_arg, _arg1) {
